...
class Mobile(ASN):
    def __init__(self):
        ...
        self._lane = Manager().Value('i', 4)  # OBU
        self._nextLane = Manager().Value('i', 11)
        ...
        try:
            ...
            while True:
                ...
                if distance >= 40:
                    ...
                    self._speed.value = int((distance - 7) // 3)
        except Exception:
