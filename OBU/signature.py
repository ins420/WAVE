...
def verify_signature(tbs_data: dict, certificate: dict or bytes, signature: bytes) -> bool:
    ...
    if certificate["toBeSigned"]["validityPeriod"]["duration"][0] == "years":
        ...
        print("\n\n" + '\033[47m\033[91m' + "/////////////////////////////////" + '\033[0m')
        print('\033[47m\033[91m' + " " * 33 + '\033[0m')
        print('\033[47m\033[91m' + "Certification Error !".center(33, ' ') + '\033[0m')
        print('\033[47m\033[91m' + "Expiry Date...".center(33, ' ') + '\033[0m')
        print('\033[47m\033[91m' + " " * 33 + '\033[0m')
        print('\033[47m\033[91m' + "/////////////////////////////////" + '\033[0m\n')
        return False
    ...
    try:
        ...
        print('\033[47m\033[91m' + " " * 33 + '\033[0m')
        print('\033[47m\033[91m' + "Certification Error !".center(33, ' ') + '\033[0m')
        print('\033[47m\033[91m' + "Verification Error...".center(33, ' ') + '\033[0m')
        print('\033[47m\033[91m' + " " * 33 + '\033[0m')
        print('\033[47m\033[91m' + "/////////////////////////////////" + '\033[0m\n')
        return False
