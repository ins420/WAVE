...
try:
    ...
    start = time.time() + 2
    # if not self._nextLane:
    #     self._changeLane = True
    ...
    while True:
        ...
        if is_continue:
            # For Right
            if (3, 1) in [(2, 7), (4, 11), (12, 6), (7, 1), (11, 5), (6, 10), (3, 8), (9, 4)]:
            # if (self._lane, self._nextLane) in [(2, 7), (4, 11), (12, 6), (7, 1), (11, 5), (6, 10), (3, 8), (9, 4)]:
            ...
            if TrackSensorLeftValue1 == True and TrackSensorLeftValue2 == True and TrackSensorRightValue1 == True and TrackSensorRightValue2 == True:
                if start < time.time():
                    print("ChangeLane : {} -> {} ") # .format(self._lane, self._nextLane))
                    # self._lane = self._nextLane
                    # self._changeLane = True
                    start = time.time() + 3
        else:
            brake()
