...
class Mobile(ASN):
    def __init__(self):
        ...
        self._lon = 0
        self._alt = 0
        self._speed = Manager().Value('i', 12)
        self._heading = 0
        self._offset = 0
    ...
    def _avoid_ultrasonic(self):
        try:
            ...
            while True:
                ...
                if distance >= 40:
                    self._speed.value = 12
                elif distance <= 20:
                    self._speed.value = 0
                else:
                    self._speed.value = int((distance-20) // 1.7)
        ...
        try:
            ...
            while True:
                ...
                if is_continue:
                    ...
                    #if (2, 8) in [(2, 7), (4, 11), (12, 6), (7, 1), (11, 5), (6, 10), (3, 8), (9, 4)]:
